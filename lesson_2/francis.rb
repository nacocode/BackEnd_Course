...
def display_results(game_result)
  if game_result == 'TIE'
    prompt("It's a tie!")
  elsif game_result == 'PLAYER_WON'
    prompt("You won!")
  else
    prompt("Computer won!")
  end
...
def keep_score(game_result)
  ...
  prompt("Player's score : #{score['player']}, Computer's score: #{score['computer']}, Tie games: #{score['tie']}")
end

#def score_keeper(player_choice, computer_choice)
#  player_score = 0
#  computer_score = 0
#
...
loop do
  ...
  prompt("You chose : #{player_choice}
   ...
   game_result = player_wins?(player_choice, computer_choice)

  display_results(game_result)
  #score_keeper(game_result)

  keep_score(score, game_result)
